...
#ifndef RENDERINGX_EXAMPLE_RENDERBUFFER_H
#define RENDERINGX_EXAMPLE_RENDERBUFFER_H
...
private:
    ...
    GLuint mOffscreenRenderTexture;

    GLuint mTexture;
    const int RENDERBUFFER_W=512,RENDERBUFFER_H=512;
    glm::mat4 projection_renderbuffer;

};

#endif //RENDERINGX_EXAMPLE_RENDERBUFFER_H
