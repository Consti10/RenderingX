...
private:
    ...
    GLProgramVC::ColoredGLMeshBuffer mVertexBufferVC;
    //
    GLProgramVC::ColoredGLMeshBuffer solidRectangleYellow;
    GLProgramVC::ColoredGLMeshBuffer solidRectangleBlack;
