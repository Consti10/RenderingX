...
public:
    ...
    static const void makeTesselatedColoredRect(GLProgramVC::Vertex array[],const int tesselation,const glm::vec3& point,glm::vec3& width,glm::vec3& height,const TrueColor color){
